...
hubspot_company_id, xero_contact_id, harvest_customer_id, harvest_address, xero_is_customer, xero_is_supplier, xero_customer_status, harvest_customer_created_at, harvest_customer_currency, harvest_customer_is_active, hubspot_first_deal_created_date, hubspot_twitterhandle, hubspot_country, hubspot_total_money_raised, hubspot_city, hubspot_total_revenue, hubspot_annual_revenue, hubspot_website, hubspot_owner_id, hubspot_industry, hubspot_linkedin_bio, hubspot_is_public, hubspot_domain, hubspot_created_date, hubspot_type, hubspot_state, hubspot_lifecycle_stage, hubspot_description FROM `ra-development.ra_data_warehouse.combined_raw_companies` 
